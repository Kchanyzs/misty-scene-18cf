...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/misty-scene-18cf
```

A live public deployment of this template is available at [https://misty-scene-18cf.templates.workers.dev](https://misty-scene-18cf.templates.workers.dev)
